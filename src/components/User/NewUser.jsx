...
function User(props) {
    ...
    return (
        <React.Fragment>
            <Button onClick={() => setModalShow(true)} outline={true} className="bg-sitebg-50" disabled={userInfo?.role != 2 ? false : true} >
            ...
            >
                ...
                <Modal.Body className="overflow-y-auto" style={{ maxHeight: "70vh" }}>
                    ...
                    <label className="inline-flex relative items-center cursor-pointer m-4">
                        ...
                        <span className="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">title={t("use_company_address")}</span>
                    </label>
