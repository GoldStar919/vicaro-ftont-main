...
import { setCurrentWineMenu, removeMenu, getMenusByFilter, getMenuTotalCount } from '../../redux/menuReducer';
        ...
        <React.Fragment>
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                <th onClick={() => gotoMenuEditPage()} scope="row" className="flex items-center py-4 px-6 text-gray-900 whitespace-nowrap dark:text-white">
                    <img className="w-auto h-20 rounded-full" src={`${API_BASE}/public/${restaurant_logo.changed_name ? restaurant_logo.changed_name : "menu-empty.png"}`} alt="empty" />
                    <div className="pl-3">
