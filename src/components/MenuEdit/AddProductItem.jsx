            ...
            <div className="grid grid-cols-12 bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                <div className="col-span-1 p-4 w-4 m-auto">
                    <div className="flex items-center">
                        <input id={`checkbox-table-search-${_id}`} onChange={() => { checkCart() }} checked={check_state} type="checkbox" className="w-4 h-4 text-blue-600 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
