...
function SortModal(props) {
    ...
    return (
        <div className="grid gap-4 align-middle pb-2" style={{ gridTemplateColumns: "1.5fr 3fr 3fr 0.5fr 1fr" }}>
            ...
            <input type="checkbox" onChange={() => clickExistCheck(props.pos)} checked={existCheck} className={`${existCheckVisible ? "visible" : "collapse"} w-4 h-4 m-auto text-blue-600 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600`} />
