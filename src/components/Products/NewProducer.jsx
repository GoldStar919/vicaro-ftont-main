...
function Producer(props) {
    ...
    return (
        <React.Fragment>
            <div onClick={() => setModalShow(true)} className="flex justify-center text-sitetx-50 py-2 px-4 m-auto cursor-pointer">
            ...
            >
                ...
                <Modal.Footer>
                    <div className="flex flex-wrap items-center gap-4 m-auto">
                        <div>
                            <Button onClick={() => setModalShow(false)} className="bg-white bg-opacity-0 text-sitetx-100">
