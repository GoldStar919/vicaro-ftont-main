...
function ProductTablePagination(props) {
    const { t } = useTranslation();
    const { productState } = useSelector((state) => state);
    const { filter_count } = productState;
    ...
    const total_count = filter_count; //activeState == "active" ? active_count : activeState == "inactive" ? inactive_count : activeState == "all" && count;
