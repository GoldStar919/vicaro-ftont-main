...
import { HiDotsHorizontal, HiOutlineMail, HiOutlinePhone, HiOutlineCheckCircle, HiOutlineTrash } from "react-icons/hi";
import { AiOutlineCloseCircle } from "react-icons/ai";
import { MdOutlineLocationOn } from "react-icons/md";
import { removeCompany, getCompaniesByFilter, setCompanyActive, getCompanyTotalCount } from '../../redux/companyReducer';
        ...
        <React.Fragment>
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                <th onClick={() => setModalShow(true)} scope="row" className="flex items-center py-4 px-6 text-gray-900 whitespace-nowrap dark:text-white">
                    <img className="w-auto h-20 rounded-full" src={`${API_BASE}/public/${logo.changed_name ? logo.changed_name : "company-empty.png"}`} alt="empty" />
                    <div className="pl-3">
